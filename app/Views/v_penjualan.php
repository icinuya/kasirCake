...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?= base_url('AdminLTE') ?>index3.html" class="navbar-brand">
                    <span class="brand-text font-weight-light"><i class="fas fa-shopping-cart text-pink"></i><b>Transaksi Penjualan</b></span>
                </a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label>Kasir</label>
                                            <label class="form-control form-control-lg text-primary"><?= session()->get('nama') ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <a class="btn btn-flat btn-success" data-toggle="modal" data-target="#pembayaran" onclick="Pembayaran()"><i class="fas fa-cash-register"></i> Buy</a>
                                            </div>
                                        </div>
                                        <?php echo form_close() ?>
                                    </div>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>mooncake <a href="https://adminlte.io"></a></strong>
        </footer>
    </div>
    <!-- ./wrapper -->
            ...
            $('#kode_produk').keydown(function(e) {
                ...
                if (e.keyCode == 13) {
                    ...
                    if (kode_produk == '') {
                        Swal.fire({
                            title: "The kode?",
                            text: "I thingk u haven't entered it yet :)",
                            icon: "question"
                            // backdrop: `
                            //rgba(0,0,123,0.4)
                            // url("<?= base_url('AdminLTE') ?>/dist/img/haruto.gif")
                            // left top
                            // no-repeat
                            //`
                        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.nama_produk == '') {
                       ...
                       // $('[name="harga_beli"]').val(response.harga_jual);
                        $('#qty').focus();
                    }
                }
            });
