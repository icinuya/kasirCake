<div class="col-md-12">
    <div class="card card-primary ">
        <div class="card-header">
            ...
            <button type="button" onclick="NewWin=window.open('<?= base_url('Laporan/PrintDataProduk') ?>', 'NewWin', 'toolbar=no, width=1150, height=600, scrollbars=yes')" 
            class="btn btn-primary btn-sm float-right mt-2"><i class="fa fa-print"></i><b> Print</b></button>
                ...
                <tbody>
                    ...
                    foreach ($produk as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-right" hidden>Rp. <?= number_format($value['harga_beli'], 0) ?></td>
                            <td class="text-center"><?= $value['stok'] ?></td>
                            <td class="text-center">
                                <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit-Data<?= $value['id_produk'] ?>"><i class="ti ti-pencil"></i></button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label form="">Modal</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Rp.</span>
                        </div>
                        <input name="harga_beli" id="harga_beli" class="form-control" value="<?= old('harga_beli') ?>" placeholder="Modal" required>
                    </div>
                </div>

                <div class="form-group">
                    <label form="">Stok</label>
...
<?php foreach ($produk as $key => $value) { ?>
    <div class="modal fade" id="edit-Data<?= $value['id_produk'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="btn btn-default ti-pencil">Edit Data <?= $subjudul ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="harga_beli" id="harga_beli<?= $value['id_produk'] ?>" value="<?= $value['harga_beli'] ?>" class="form-control" placeholder="Modal" required>
                        </div>
                    </div>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default  ti-pencil" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary btn-fla">Save</button>
                </div>
                <?php echo form_close() ?>
            </div>
...
<?php foreach ($produk as $key => $value) { ?>
    <div class="modal fade" id="delete-Data<?= $value['id_produk'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="btn btn-default ti-pencil">Delete Data <?= $subjudul ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
