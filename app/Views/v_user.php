<div class="col-md-12">
 ...
 <button class="btn btn-warning btn-sm btn-flat"  data-toggle="modal" data-target="#edit-Data<?= $value['id_user'] ?>"><i class="ti ti-pencil"></i></button>
...
<div class="modal fade" id="Tambah-Data">
 ...
 <!--Modall Edit Data-->
  ...
  <span aria-hidden="true">&times;</span>
   ...
   <div class="form-group">
  <label form="">Nama</label>
 <input name="nama" class="form-control" value='<?= $value['nama']?>' placeholder="Nama" required>
 </div>
 ...
 <select name="level" class="form-control">
  ...
  <div class="modal-footer justify-content-between">
     <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
     <button type="submit" class="btn btn-warning btn-fla">Update</button>
  </div>
 <?php echo form_close() ?>
   </div>
          <!-- /.modal-content -->
 ...
 <div class="modal-content">
  ...
  <div class="modal-body">
  Apakah Anda Yakin Hapus <b><?= $value['nama']?></b>?
 </div>
  <div class="modal-footer justify-content-between">
 <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
